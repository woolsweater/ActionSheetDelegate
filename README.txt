...
The contents of this repository are in the public domain. I retain no copyright, and they are offered without restriction or warranty. You are free to use them in whatever way you like. If you would like to mention that I created the code, it will be appreciated, but it isn't at all necessary. For further details, please see COPYING.txt